...
public class ErrorMessages {
    ...
    public final static String INPUT_NOT_DIVIDE_LOTTO_COST = STR."[ERROR] 입력 값은 \{Lotto.COST}로 나누어 떨어져야 합니다.";
    public final static String INPUT_NOT_BETWEEN_LOTTO_NUM = STR."[ERROR] 로또 번호는 \{Lotto.MIN_VALUE}부터 \{Lotto.MAX_VALUE} 사이의 값이어야 합니다.";
